export default {
  translation: {
    ...
    program_page: {
      ...
      view_on_map: 'Auf Google Maps ansehen',
      days: {
        day1: {
          ...
          sessions: [
            ...
            },
            {
              ...
              participants: [
                ...
                'Technischer Koordinator der Nationalen Wassergesellschaft des Senegal (SONES) | El Hadj Ada NDAO',
                'Berater des Premierministers für Wasserbau und Sanitärversorgung | Mohamed Kankou',
                'Geschäftsführender Direktor des Verwaltungsrats der Nationalen Wasser- und Sanitäragentur von Kap Verde (ANAS) | Hipólito Gonçalves',
                'Generaldirektor des Nationalen Büros für Elektrizität und Trinkwasser (ONEE) | Tarik Hammane (ausstehend)'
              ]
            },
            {
              time: '11:00 – 11:30',
          ...
          sala_a: {
            ...
            sessions: [
              ...
              {
                time: '16:30',
                title: 'Ende des Tages',
                type: 'break'
              },
              {
                time: '20:30',
                title: 'Willkommenscocktail',
                type: 'break',
                description: 'Willkommenscocktail für die Veranstaltungsteilnehmer. Er findet im Hotel Sheraton Fuerteventura Beach, Golf & Spa Resort, Av. de las Marismas, 1, 35610 Antigua, Las Palmas statt. Im Salon Tenerife um 20:45 Uhr.',
    ...
    speaker_profiles: {
      ...
      'Hipólito Gonçalves': {
        ...
        title: 'Geschäftsführender Direktor des Verwaltungsrats der Nationalen Wasser- und Sanitäragentur von Kap Verde (ANAS)',
        ...
        bio: 'Maschinenbauingenieur mit Spezialisierung auf Energie und Thermodynamik, Absolvent des Höheren Ingenieurinstituts von Lissabon. Seit Februar 2025 ist er als Geschäftsführender Direktor der Nationalen Wasser- und Sanitäragentur (ANAS) von Kap Verde tätig, wo er die technischen und strategischen Bereiche des Wasser- und Sanitärsektors leitet. Mit über zwei Jahrzehnten Erfahrung in Ingenieurwesen, Projektmanagement und Hochschullehre hat er an wichtigen Initiativen wie dem Projekt zur Entwicklung der Wasserversorgungssysteme auf der Insel Santiago, finanziert von der JICA, gearbeitet. Er ist auch Professor an der Universität von Kap Verde und hat an verschiedenen internationalen Schulungen in Entsalzung, erneuerbaren Energien und Wasserressourcenmanagement teilgenommen. Seine Arbeit konzentriert sich auf die Förderung von Nachhaltigkeit, Innovation und Modernisierung der öffentlichen Wasserwirtschaft im Land.'
      },
      'Hyacinth Elayo': {
        name: 'Hyacinth Elayo',
        title: 'Beauftragte für Nachhaltige Energiepolitik, ECOWAS-Zentrum für Erneuerbare Energien und Energieeffizienz (ECREEE)',
      ...
      'Silvia Camacho Martín': {
        ...
        title: 'Technikerin für Außenförderung bei Proexca',
        ...
        bio: 'Technikerin für Außenförderung bei Proexca. Sie war 3 Jahre lang Koordinatorin des Programms für internationale Ausschreibungen. Sie hat verschiedene multilaterale Organisationen besucht, wie die Zentrale der Weltbank in Washington D.C. und die Afrikanische Entwicklungsbank in Abidjan, und sich mit deren Richtlinien, Vorschriften und Prioritäten sowie mit Begünstigten befasst, in denen Projekte geplant oder entwickelt werden. Sie war Teil globaler Netzwerke zur Erkennung von Chancen und zur Zusammenführung von Partnern bei der Teilnahme an internationalen Ausschreibungsverfahren. Zuvor hatte sie andere Schlüsselrollen in diesem Bereich inne, wie etwa als Verantwortliche für internationale Geschäftsentwicklung. Silvia besitzt einen Master in International Business und einen Bachelor in Internationaler Betriebswirtschaftslehre sowie vielfältige Berufserfahrung auf internationaler Ebene, immer im Bereich der Geschäftsentwicklung für prioritäre Sektoren der kanarischen Wirtschaft.'
      },
      'Daniel Jacobo Orea': {
      ...
      'Tarik Hamane': {
        name: 'Tarik Hamane',
        title: 'Generaldirektor des Nationalen Amts für Elektrizität und Trinkwasser Marokkos (ONEE)',
    ...
    map: {
      ...
      error_title: 'Fehler beim Laden der Karte',
      loading_error: 'Google Maps konnte nicht geladen werden. Bitte überprüfen Sie Ihre Internetverbindung.',
      api_key_missing: 'Google Maps API-Schlüssel fehlt. Bitte konfigurieren Sie VITE_GOOGLE_MAPS_API_KEY in der .env-Datei',
      setup_instructions: 'Siehe .env.example-Datei für Anweisungen zur Einrichtung der Google Maps API.',
      view_in_google_maps: 'In Google Maps anzeigen',
      show_route: 'Route vom Flughafen anzeigen',
      airport_route: 'Flughafen-Route',
      ...
      simple_map: 'Einfache Karte',
      nearby_restaurant: 'Restaurants in der Nähe',
      nearby_parking: 'Parkplätze in der Nähe',
      nearby_gas_station: 'Tankstellen in der Nähe'
    },
    thankYou: {
      title: 'Danke!',
      message: 'Das gesamte Africagua 2025-Team dankt Ihnen für Ihre Teilnahme an dieser IX. Ausgabe des Internationalen Forums für Wasser und Erneuerbare Energien.',
      future: {
        title: 'Bis 2027',
        message: 'Wir hoffen, Sie bei der nächsten Ausgabe von Africagua Canarias 2027 wiederzusehen, wo wir weiterhin die internationale Zusammenarbeit und nachhaltige Entwicklung zwischen Europa und Afrika fördern werden.'
      },
      signature: 'Das Africagua Canarias Team'
    }
  }
};