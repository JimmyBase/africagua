...
const Hero2025 = () => {
  ...
  return (
    <>
      {/* Desktop Version */}
      <div className="relative hidden md:block h-screen overflow-hidden pt-20">
        {/* Navigation Arrows */}
        <button
          onClick={prevSlide}
        ...
        <div className="relative w-full h-full">
          ...
          >
            ...
            >
              <source
                src="https://firebasestorage.googleapis.com/v0/b/africagua-eb795.firebasestorage.app/o/PORTADA%2FV%C3%ADdeo%20sin%20t%C3%ADtulo%20%E2%80%90%20Hecho%20con%20Clipchamp.mp4?alt=media&token=c078bc6c-7db4-4660-a60d-8601b07928cc"
                type="video/mp4"
              />
      ...
      {/* Mobile Version */}
      <div className="relative md:hidden h-[60vh] overflow-hidden pt-20">
        {/* Navigation Arrows */}
        <button
          onClick={prevSlide}
