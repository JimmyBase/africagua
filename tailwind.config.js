  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { opacity: '1', boxShadow: '0 0 20px rgba(245, 158, 11, 0.5)' },
          '50%': { opacity: '0.8', boxShadow: '0 0 40px rgba(245, 158, 11, 0.8)' },
        },
        bounceGentle: {
          '0%, 100%': { transform: 'translateY(0)' },
      ...
      boxShadow: {
        ...
        'ocean': '0 4px 24px rgba(14, 165, 233, 0.2)',
        'coral': '0 4px 24px rgba(249, 115, 22, 0.2)',
      },
      fontSize: {
